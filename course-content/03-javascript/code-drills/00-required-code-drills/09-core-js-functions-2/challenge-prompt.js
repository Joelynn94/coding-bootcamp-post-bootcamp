...
function danceParty(str) {
  ...
  const wibbleResult = wibble(str)
  const warbleResult = warble(str)

  const results = `${wibbleResult} ${warbleResult}`

  return results
}

// console log the result of calling your "danceParty" function with your name as the argument
console.log(danceParty('Joe'))

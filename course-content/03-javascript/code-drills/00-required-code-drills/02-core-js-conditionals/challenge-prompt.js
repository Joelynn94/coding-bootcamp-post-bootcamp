...
const characterOneSalary = 100000.0;
...
const characterOneYearlySavings =
  characterOneSalary - (characterOneYearlyExpenses + characterOneYearlyRent);
...
const characterTwoYearlyRent = 12 * characterTwoRent;

// make a variable called `characterTwoYearlyExpenses` and assign it to be 12 times `characterTwoExpenses`
const characterTwoYearlyExpenses = 12 * characterTwoExpenses;

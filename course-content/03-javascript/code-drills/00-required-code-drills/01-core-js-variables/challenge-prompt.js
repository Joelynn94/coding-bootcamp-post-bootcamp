...
const statementOne = `${subject}: ${fullName} is a ${nationality} ${profession} born in ${birthYear}`;
...
const statementFour = `She was a ${nationality} Citizen who lived in ${cityLocation}, ${countryLocation} until her passing in ${deathYear} at the age of ${ageAtPassing}`;

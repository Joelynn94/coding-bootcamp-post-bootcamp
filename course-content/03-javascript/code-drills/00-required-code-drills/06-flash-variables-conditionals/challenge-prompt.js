...
const transportationCost = 350;

// declare a variable computerCost and assign it a value of 2000
const computerCost = 2000;

// write an if statement that checks whether the sum of all our costs is within the budget.
if (
  rentCost + utilitiesCost + foodCost + transportationCost + computerCost <=
  budget
) {
  // if it is within budget, console log out the total cost,
  console.log(
    rentCost + utilitiesCost + foodCost + transportationCost + computerCost
  );
} else {
  // otherwise, create an alert telling us the sum of all the costs.
  alert(
    rentCost + utilitiesCost + foodCost + transportationCost + computerCost
  );
}
...
if (
  rentCost > utilitiesCost + foodCost + transportationCost &&
